(function() {
  ...
  class BUZZER {
    ...
    /**
      * The Buzzer class is a object used to represent the BLE service. Note for this project
    ...
    constructor() {
        ...
        this.buzzerUUID =       '917649a4-d98e-11e5-9eec-0002a5d5c51b';
        this.device = null;
        this.server = null;
...
// makes the buzzer object available to therest of the program, remeber to change this to reflect your project
window.buzzer = new BUZZER();
